...
export default function MachineManagement() {
  ...
  const handleActivateMachine = useCallback(async (machineId) => {
    try {
      const result = await deactivateMachine(machineId);
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <div className="max-h-[500px] overflow-y-auto">
                <table className="w-full" role="table" aria-label="Registered machines">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    {currentMachines.map((machine) => {
                      ...
                      return (
                        <tr
                          key={machine._id}
                          className={`hover:bg-slate-50 transition-colors ${isInactive ? 'opacity-60 bg-slate-50' : ''
                            }`}
                          tabIndex={0}
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-2">
                              ...
                              {machine.status === 'active' ? (
                                ...
                                <button
                                  onClick={() => handleActivateMachine(machine._id)}
                    ...
                    (_, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-10 h-10 rounded ${currentPage === pageNumber
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="text-sm text-gray-600">
                    ...
                    {filteredMachines.length === 0
                      ...
                      : indexOfFirstItem + 1}
                    {" "}to{" "}
                    {Math.min(indexOfLastItem, filteredMachines.length)}
                    {" "}of{" "}
